...
@Table(value = "adcpa_m_glider_instrument")
public class AdcpaMGliderInstrument extends CassandraParticle {
    ...
    @Column(value = "sensor_source_temperature_eu")
    private int sensorSourceTemperatureEu;
    ...
    @Column(value = "sensor_available_temperature_eu")
    private int sensorAvailableTemperatureEu;
    ...
    @Column(value = "bit_error_number")
    private int bitErrorNumber;

    @Column(value = "bit_error_count")
    private int bitErrorCount;
    ...
    @Column(value = "bt_eastward_velocity")
    private int btEastwardVelocity;
    ...
    @Column(value = "bt_beam3_correlation")
    private int btBeam3Correlation;
    ...
    public void fill(DataParticleJson particle, String sensor, String method) {
        ...
        setSensorSourceTemperatureEu((int) particle.get("sensor_source_temperature_eu"));
        ...
        setSensorAvailableTemperatureEu((int) particle.get("sensor_available_temperature_eu"));
        ...
        setBitErrorNumber((int) particle.get("bit_error_number"));
        setBitErrorCount((int) particle.get("bit_error_count"));
        ...
        setBtEastwardVelocity((int) particle.get("bt_eastward_velocity"));
        ...
        setBtBeam3Correlation((int) particle.get("bt_beam3_correlation"));
    ...
    public int getSensorSourceTemperatureEu() {
        return sensorSourceTemperatureEu;
    }

    public void setSensorSourceTemperatureEu(int sensorSourceTemperatureEu) {
        this.sensorSourceTemperatureEu = sensorSourceTemperatureEu;
    }
    ...
    public int getSensorAvailableTemperatureEu() {
        return sensorAvailableTemperatureEu;
    }

    public void setSensorAvailableTemperatureEu(int sensorAvailableTemperatureEu) {
        this.sensorAvailableTemperatureEu = sensorAvailableTemperatureEu;
    }
    ...
    public int getBitErrorNumber() {
        return bitErrorNumber;
    }

    public void setBitErrorNumber(int bitErrorNumber) {
        this.bitErrorNumber = bitErrorNumber;
    }
    public int getBitErrorCount() {
        return bitErrorCount;
    }

    public void setBitErrorCount(int bitErrorCount) {
    ...
    public int getBtEastwardVelocity() {
        return btEastwardVelocity;
    }

    public void setBtEastwardVelocity(int btEastwardVelocity) {
        this.btEastwardVelocity = btEastwardVelocity;
    }
    ...
    public int getBtBeam3Correlation() {
        return btBeam3Correlation;
    }

    public void setBtBeam3Correlation(int btBeam3Correlation) {
        this.btBeam3Correlation = btBeam3Correlation;
    }
