...
@Table(value = "cgldr_adcpa_pd0_parsed")
public class CgldrAdcpaPd0Parsed extends CassandraParticle {
    ...
    @Column(value = "bottom_track_id")
    private int bottomTrackId;
    ...
    public void fill(DataParticleJson particle, String sensor, String method) {
        ...
        setBottomTrackId((int) particle.get("bottom_track_id"));
    ...
    public int getBottomTrackId() {
        return bottomTrackId;
    }

    public void setBottomTrackId(int bottomTrackId) {
        this.bottomTrackId = bottomTrackId;
    }
