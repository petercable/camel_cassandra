...
@Table(value = "pco2a_a_dcl_instrument_water_recovered")
public class Pco2aADclInstrumentWaterRecovered extends CassandraParticle {
    ...
    @Column(value = "measured_water_co2")
    private float measuredWaterCo2;
    ...
    public void fill(DataParticleJson particle, String sensor, String method) {
        ...
        setMeasuredWaterCo2((float) particle.get("measured_water_co2"));
    ...
    public float getMeasuredWaterCo2() {
        return measuredWaterCo2;
    }

    public void setMeasuredWaterCo2(float measuredWaterCo2) {
        this.measuredWaterCo2 = measuredWaterCo2;
    }
