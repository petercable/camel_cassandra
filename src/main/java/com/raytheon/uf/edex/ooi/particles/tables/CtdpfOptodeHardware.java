...
@Table(value = "ctdpf_optode_hardware")
public class CtdpfOptodeHardware extends CassandraParticle {
    ...
    @Column(value = "volt1_type")
    private String volt1Type;

    @Column(value = "volt1_serial_number")
    private String volt1SerialNumber;
    ...
    public void fill(DataParticleJson particle, String sensor, String method) {
        ...
        setVolt1Type((String) particle.get("volt1_type"));
        setVolt1SerialNumber((String) particle.get("volt1_serial_number"));
    }
    ...
    public String getVolt1Type() {
        return volt1Type;
    }

    public void setVolt1Type(String volt1Type) {
        this.volt1Type = volt1Type;
    }
    public String getVolt1SerialNumber() {
        return volt1SerialNumber;
    }

    public void setVolt1SerialNumber(String volt1SerialNumber) {
        this.volt1SerialNumber = volt1SerialNumber;
    }
